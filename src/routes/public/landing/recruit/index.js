...
// img
import recruiter from "../../../../assets/img/recruiter.jpg";
      ...
      <HeroContainer>
        <LeftGrid item xs={12} md={6}>
          ...
          <LeftContentContainer>
            <Title>Automate Your Recruiting</Title>
            <SubTitle>Find the right fit for your company</SubTitle>
            <Description>
        ...
        <RightGrid item md={6}>
          <RightContentContainer>
            <Typewriter>Automate Your Hiring</Typewriter>
          </RightContentContainer>
        </RightGrid>
      </HeroContainer>
    </>
